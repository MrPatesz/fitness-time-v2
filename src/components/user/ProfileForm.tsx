...
export const ProfileForm: FunctionComponent<{
  ...
  const form = useForm<UpdateProfileType>({
    ...
    validate: {
      ...
      image: (value) =>
        !value || ImageSchema.safeParse(value).success ? null : t('profileForm.image.error'),
    },
  });
            ...
            <form onSubmit={form.onSubmit((data) => updateProfile.mutate(data))}>
              <Stack>
                ...
                <ThemeColorPicker
                  ...
                  onChange={
                    form.getInputProps('themeColor').onChange as (newValue: ThemeColor) => void
                  }
                />
                <LocationPicker
              ...
              <Group position="apart" align="end">
                ...
                <HoverOverlay
                  ...
                  hoverChildren={
                    ...
                    >
                      <IconTrash size={32} color="white" />
                    </ActionIcon>
                  }
                >
                  <UserImage user={profileQuery.data} size={imageSize} />
                </HoverOverlay>
              </Group>
            </BorderComponent>
          )}
